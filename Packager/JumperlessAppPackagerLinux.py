...
def package_linux_appimage():                                             #! Linux
...
def create_appimage_for_arch(arch_name, dist_path, appdir_path, appimage_path, executable_name): #! Linux
...
Exec=AppRun
Icon=icon
Comment=Jumperless Wokwi Bridge App
...
def download_appimagetool():                                                      #! Linux - AppImageTool
...
def create_appimage_launchers(appimage_dir):                      #! Linux - AppImageTool
    """Create launcher scripts for AppImage directory"""
...
def create_organized_structure(appimage_dir):                              #! Put in the Python script and readmes
...
def create_distribution_archive(appimage_dir):                              #! Linux - Create archive
